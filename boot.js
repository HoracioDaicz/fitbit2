...
if (!window.location.hash) {
    window.location.replace('window.location.replace('https://www.fitbit.com/oauth2/authorize?response_type=token&client_id=238BW6&redirect_uri=https://horaciodaicz.github.io/fitbit/&scope=activity%20nutrition%20heartrate%20location%20nutrition%20profile%20settings%20sleep%20social%20weight');');
} else {
